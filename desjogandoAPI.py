...
async def login(usuario: Usuario):
    ...
    if result is None:
        # Se o usuário não existir, cria o usuário com saldo inicial de 2000
        await conn.execute('INSERT INTO usuarios (nome, saldo) VALUES ($1, $2)', nome, 2000)
        saldo = 2000
    else:
        saldo = result["saldo"]
